...
export const MOCK_CONVERSATIONS: MockConversation[] = [
  ...
  },
  {
    id: "4",
    name: "Zalo Official",
    lastMessage: "Cập nhật tính năng mới cho tài khoản của bạn",
    time: "Hôm qua",
  ...
  },
  {
    id: "6",
    name: "Team Design",
    lastMessage: "Đã upload Figma — nhờ mọi người review",
    time: "CN",
    unreadCount: 5,
  ...
  },
  {
    id: "7",
    name: "CSKH — Giao hàng",
    lastMessage: "Đơn #8821 đang được vận chuyển",
    time: "09:41",
    unreadCount: 0,
  ...
  },
  {
    id: "9",
    name: "Bạn chung — Hải",
    lastMessage: "Ok để tôi check lại giúp bạn",
    time: "Thứ 6",
    unreadCount: 3,
